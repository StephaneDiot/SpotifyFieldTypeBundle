 ...
 */
namespace SpotifyFieldTypeBundle\FieldType\DataTransformer;
 ...
 */
class SpotifyValueTransformer implements DataTransformerInterface
{
    /**
    ...
    public function transform($value)
    {
        ...
        //only shows url in input, we don't need the spotify 'stuff'
        return $value->url;
    }
